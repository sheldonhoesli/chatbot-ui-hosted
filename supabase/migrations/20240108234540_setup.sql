...
AS $$
DECLARE
  project_url TEXT := 'https://ftrtrtqpqhhovhrcjoqm.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZ0cnRydHFwcWhob3ZocmNqb3FtIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0ODU0NTM4NSwiZXhwIjoyMDY0MTIxMzg1fQ.5DhCi4ZjIYtSoxDrcREjoaAifOsPP_9u_xUdFOZhTLY'; -- full access needed for http request to storage
